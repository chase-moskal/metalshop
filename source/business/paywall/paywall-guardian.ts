...
import {PaywallGuardianTopic, VerifyToken} from "../../interfaces.js"

export function makePaywallGuardian({verifyToken, authVanguard}: {
	verifyToken: VerifyToken
	authVanguard: AuthVanguardTopic
}): PaywallGuardianTopic {
	const internal = {}
	return {
		grantPremium(options: {userId: string; expires: number}): Promise<void> {
			return null
		},
	}
}
